...
_Since the individual talks haven't been released (and I think you should see them all), scroll to the bottom for timestamped list of all the talks!_
...
I'm not going to complete the accessibility marathon over night but I can do a little more each day going forward.
...
> Remeber that, sooner or later, before it reaches perfection, you will have to let it go and move on and start to write the next thing.
